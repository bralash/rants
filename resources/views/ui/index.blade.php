                                ...
                                <div class="col-12 col-md-8 col-xl-9">
                                    <header class="entry-header">
                                        <div class="entry-meta">
                                            <span class="posted-in"><span class="screen-reader-text">Posted in: </span> <a href="episodes.html" rel="bookmark">Season {{$episode->season}}</a></span>  <span class="posted-on"><span class="screen-reader-text">Posted in: </span> Episode {{$episode->episode}}</span> <span class="posted-on"><span class="screen-reader-text">Posted on: </span> <span class="entry-date published">3 September 2017</span></span> 
                                        </div>
